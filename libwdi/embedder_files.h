...
// inf templates for the tokenizer ("" directory means no extraction)
	...
	{ 0, SRCDIR "\\libusbk.inf.in", "" },
	{ 0, SRCDIR "\\usbser.inf.in", "" },
// cat file listsfor self signing
	{ 0, SRCDIR "\\winusb.cat.in", "" },
	{ 0, SRCDIR "\\libusb0.cat.in", "" },
	{ 0, SRCDIR "\\libusbk.cat.in", "" },
	{ 0, SRCDIR "\\usbser.cat.in", "" },
};
